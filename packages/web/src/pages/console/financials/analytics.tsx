...
import AnalyticsTab from '../../../components/Financials/AnalyticsTab';
...
export default function AnalyticsPage({ session }: AnalyticsPageProps) {
  return (
    <>
      <Head>
        <title>Analytics - Pentara Console</title>
        <meta name="description" content="Financial analytics and performance metrics" />
      </Head>
